## A Python Library to Study Mispricing (market-neutral) and Momentum Divergence (momentum-neutral) Strategies for pairs (triplets, ...) and Using generative AI for portfolio optimization
